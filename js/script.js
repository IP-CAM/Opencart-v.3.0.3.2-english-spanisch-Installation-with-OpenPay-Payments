    ...
    $(function () {
        ...
        function initCircleBg(swiper) {
            ...
            function calcCircle(swiper) {
                var activeSlide =
                    swiper.$wrapperEl[0].children[swiper.activeIndex];
                return {
                    centerX: activeSlide.getAttribute("data-circle-cx")
                        ? swiper.width *
                          activeSlide.getAttribute("data-circle-cx")
                        : swiper.width / 2,
                    centerY: activeSlide.getAttribute("data-circle-cy")
                        ? swiper.height *
                          activeSlide.getAttribute("data-circle-cy")
                        : swiper.height / 2,
                    radius: activeSlide.getAttribute("data-circle-r")
                        ? swiper.width *
                          activeSlide.getAttribute("data-circle-r")
                        : swiper.height * 0.4,
                };
            }
            ...
            swiper.params.svg = {
                fill:
                    swiper.$el[0].getAttribute("data-circle-fill") || "#f1f1f1",
                easingIn: "easeOutQuad",
                easingOut: "easeOutQuad",
            };

            swiper.svg = {};
            swiper.svg.el = document.createElementNS(
            ...
            swiper.svg.el.setAttribute(
                "viewbox",
                "0 0 " + swiper.width + " " + swiper.height
            );
            swiper.svg.circle = calcCircle(swiper);
            swiper.svg.el.innerHTML =
                '<circle fill="' +
                swiper.params.svg.fill +
                '"  cx="' +
                swiper.svg.circle.centerX +
                '" cy="' +
                swiper.svg.circle.centerY +
                '" r="' +
                swiper.svg.circle.radius +
                '"/>';
            ...
            swiper.on("resize", function () {
                swiper.svg.circle = calcCircle(swiper);
                swiper.svg.circleEl.setAttribute(
                    "cx",
                    swiper.svg.circle.centerX
                );
                swiper.svg.circleEl.setAttribute(
        ...
        function initFrameRectSerial(swiper) {
                ...
                switch (state) {
                    ...
                    case "step2":
                        return (
                            ...
                            swiper.frame.size +
                            " " +
                            (swiper.width - swiper.frame.size) +
                            "," +
                            swiper.frame.size +
                            " " +
                            swiper.width +
                    ...
                    case "step3":
                        return (
                            ...
                            (swiper.width - swiper.frame.size) +
                            "," +
                            (swiper.height - swiper.frame.size) +
                            " 0," +
                            swiper.height +
                            " Z"
                        );
            ...
            swiper.params.frame = {
                fill:
                    swiper.$el[0].getAttribute("data-frame-fill") || "#f1f1f1",
                easingIn: "easeOutQuad",
                easingOut: "easeOutQuad",
            };
            ...
            swiper.frame.el = document.createElementNS(
                "http://www.w3.org/2000/svg",
                "svg"
            );
            ...
            swiper.frame.el.setAttribute(
                "viewbox",
                "0 0 " + swiper.width + " " + swiper.height
            );
            swiper.frame.el.innerHTML =
                '<path fill="' +
                swiper.params.frame.fill +
                '" d="' +
                swiper.frame.paths.initial +
                '"/>';
                ...
                switch (state) {
                    case "next":
                        return (
                            ...
                            (swiper.width - swiper.frame.size) +
                            "," +
                            (swiper.height - swiper.frame.size / 2) +
                            " " +
                            swiper.frame.size +
                            "," +
                            (swiper.height - swiper.frame.size) +
        ...
        function initFrameRandom(swiper) {
            ...
            var randomSize = function (swiper) {
                return (
                    swiper.frame.minSize + swiper.frame.maxSize * Math.random()
                );
            };
                ...
                switch (state) {
                    case "random":
                        return (
                            ...
                            randomSize(swiper) +
                            " " +
                            (swiper.width - randomSize(swiper)) +
                            "," +
                            randomSize(swiper) +
                            " " +
                            (swiper.width - randomSize(swiper)) +
                            "," +
                            (swiper.height - randomSize(swiper)) +
                            " " +
                            randomSize(swiper) +
                            "," +
                            (swiper.height - randomSize(swiper)) +
        ...
        function initCroppingCircle(swiper) {
            ...
            var randomCenter = function (swiper) {
                return {
                    x:
                        (swiper.width - swiper.frame.radiusReduced * 2) *
                        Math.random(),
                    y:
                        (swiper.height - swiper.frame.radiusReduced * 2) *
                            Math.random() +
                        swiper.frame.radiusReduced,
                };
            };
            ...
            var genImgFillSize = function (swiper) {
                var ratio = Math.max(
                    swiper.width / swiper.frame.image.initialBox.width,
                    swiper.height / swiper.frame.image.initialBox.height
                );
                return {
            ...
            swiper.frame.radiusFull = Math.sqrt(
                Math.pow(swiper.width, 2) + Math.pow(swiper.height, 2)
            );
            swiper.frame.paths = {
                initial: calculatePath(swiper),
            ...
            swiper.frame.image.el.setAttribute(
                "width",
                swiper.frame.image.box.width
            );
            swiper.frame.image.el.setAttribute(
                "height",
        ...
        function separateCaptions(swiper) {
            ...
            var captions = swiper.$wrapperEl[0].querySelectorAll(
            ...
            // Switch slides
            swiper.captWrapperEl.children[swiper.activeIndex].classList.add(
                "active"
            );
        ...
        function initSwiperAnime(swiper) {
            ...
            for (var w = 0; w < wrappers.length; w++) {
                ...
                for (var i = 0; i < nodeList.length; i++) {
                    ...
                    bindAnimePreset(
                        el,
                        JSON.parse(el.getAttribute("data-swiper-anime"))
                    );
                }
                ...
                nodeList = wrapper.children[
                    swiper.activeIndex
                ].querySelectorAll("[data-swiper-anime]");
                for (var i = 0; i < nodeList.length; i++)
                ...
                swiper.on(
                    ...
                    (function (wrapper) {
                        return function () {
                            var nodeList = wrapper.children[
                                swiper.activeIndex
                            ].querySelectorAll("[data-swiper-anime]");
                            for (var i = 0; i < nodeList.length; i++)
                                if (nodeList[i].animeStart)
                                    nodeList[i].animeStart("next");
                        };
                    })(wrapper)
                );
                ...
                swiper.on(
                    ...
                    (function (wrapper) {
                        return function () {
                            var nodeList;
                            if (
                                typeof swiper.realPrevious === "number" &&
                                swiper.previousIndex !== swiper.realPrevious
                            ) {
                                nodeList = wrapper.children[
                                    swiper.realPrevious
                                ].querySelectorAll("[data-swiper-anime]");
                                for (var i = 0; i < nodeList.length; i++)
                                    if (nodeList[i].animeOut)
                                        nodeList[i].animeOut("next");
                            }
                            nodeList = wrapper.children[
                    ...
                    swiper.on(
                        ...
                        (function (wrapper) {
                            return function () {
                                ...
                                for (var i = 0; i < nodeList.length; i++)
                                    if (nodeList[i].animeReset)
                                        nodeList[i].animeReset();
                            };
                        })(wrapper)
                    );
                }
                ...
                if ($(item).data("jp-player-name")) {
                    ...
                    $(playerInstance.cssSelector.jPlayer).bind(
                        ...
                        function (e) {
                            ...
                            var lastPlayed = playlistItems.filter(
                                ".last-played"
                            );
            ...
            for (var i = 0; i < plugins.captcha.length; i++) {
                ...
                grecaptcha.render($capthcaItem.attr("id"), {
                    ...
                    theme: $capthcaItem.attr("data-theme")
                        ...
                        : "light",
                    callback: function (e) {
                        $($capthcaItem.attr("data-target-input")).val(e);
            ...
            for (i = 0; i < plugins.rdMailForm.length; i++) {
                ...
                $form.attr("novalidate", "novalidate").ajaxForm({
                    ...
                    beforeSubmit: function (arr, $form, options) {
                        ...
                        // If captcha response is targered to form input to server side validation then ignore to validate here to avoid duplicated validation error.
                        captcha = captcha.attr("data-target-input")
                            ? $()
                            : captcha;
        ...
        if (plugins.customCarousel.length) {
            for (var i = 0; i < plugins.customCarousel.length; i++) {
                var carousel = initCarousel({
                    ...
                    autoplay: plugins.customCarousel[i].getAttribute(
                        "data-autoplay"
                    ),
                });
            }
